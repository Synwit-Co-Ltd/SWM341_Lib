...
/*******************************************************************************************************************************
* @brief	Used for handling Standard requests for MTP class.
* @param
* @return
*******************************************************************************************************************************/
static USBH_Status USBH_MTP_Request(USBH_Info_t *phost)
...
/*******************************************************************************************************************************
* @brief	Used for managing state machine for MTP data transfers.
* @param
* @return
*******************************************************************************************************************************/
static USBH_Status USBH_MTP_Process(USBH_Info_t *phost)
{
	...
	case USBH_MTP_EVENT_CHECK:
		...
		{
			USBH_MTP_Info.state = USBH_MTP_TRANSFER;	// Event query is inserted in the middle of the data transfer and returns the data transfer
		}
		break;
...
/*******************************************************************************************************************************
* @brief	USB host MTP transfer process
* @param
* @return
*******************************************************************************************************************************/
void USBH_MTP_XferProcess(USBH_Info_t *phost)
{
	...
	case USBH_MTP_XFER_DATA_OUT_WAIT:
		...
		else if(resp == USBR_NAK)
		{
			...
			USBH_MTP_Info.state = USBH_MTP_EVENT_CHECK;		// When device returns NAK, host checks to see if the Event query needs to be executed
		}
		else if(resp == USBR_STALL)
		{
			USBH_MTP_Info.XferState = USBH_MTP_XFER_ERROR;
...
/*******************************************************************************************************************************
* @brief	USB host MTP get device info
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP open session
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get storage id
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get storage info
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get number of objects
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get object handles
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get object info
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get partial object
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP delect object
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP send object
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get device property descrtiption
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get object supported property
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get object property description
* @param
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	USB host MTP get object property list
* @param
* @return
*******************************************************************************************************************************/
