...
#define cb_item_t	CAN_RXMessage	// item type

#define CB_ITEM_N	128				// item number, the actual data can be stored is less by one, leaving a space to indicate full, to distinguish from empty
