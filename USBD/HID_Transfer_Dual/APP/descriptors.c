...
uint8_t USBD_ConfigDescriptor[] =
{
    ...
    7,                              // bLength
    USB_DESC_ENDPOINT,              // bDescriptorType
    (USB_EP_IN | EP_INT_IN_NUM2),  	// bEndpointAddress
    USB_EP_INT,                     // bmAttributes
    EP_INT_IN_PKSZ2, 0x00,         	// wMaxPacketSize
    10,    							// bInterval

    /* EP Descriptor: interrupt out. */
    7,                              // bLength
    USB_DESC_ENDPOINT,              // bDescriptorType
    (USB_EP_OUT | EP_INT_OUT_NUM2), // bEndpointAddress
    USB_EP_INT,                     // bmAttributes
    EP_INT_OUT_PKSZ2, 0x00,         // wMaxPacketSize
    10     							// bInterval
};
...
uint8_t ProductStringDesc[] =
{
    36,
    USB_DESC_STRING,
    'H', 0, 'I', 0, 'D', 0, ' ', 0, 'T', 0, 'r', 0, 'a', 0, 'n', 0, 's', 0, 'f', 0, 'e', 0, 'r', 0, ' ', 0, 'D', 0, 'u', 0, 'a', 0, 'l', 0,
};
